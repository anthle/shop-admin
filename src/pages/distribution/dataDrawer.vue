...
import { getAgentList, getAgentOrderList } from '@/service/main/distribution'
...
const { tableData, searchForm, loading, total, currentPage, getData } = useInitTable({
	searchForm: {
		type: 'all',
		starttime: null,
		endtime: null,
	...
	<el-drawer :title="drawerTitle" v-model="dialogVisible" size="50%">
		...
		<el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
			...
			<template v-else>
				...
				<el-table-column label="返佣金额" prop="commission" align="center" width="100" />
			</template>
		</el-table>

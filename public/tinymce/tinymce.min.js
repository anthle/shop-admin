...
!(function () {
	...
	const Fo = (e) => (t) => !!t && t.nodeType === e,
		...
		is = (e, t) =>
			...
			((e) =>
				zo(e) && 'A' === e.nodeName && !e.hasAttribute('href') && (e.hasAttribute('name') || e.hasAttribute('id')))(
				e
			) ||
			ls(e),
	...
	const us = (e, t = !0) =>
		...
		hs = (e, t) => {
			...
			for (let t = e[o]; t; t = t[o])
				if (us(bn(t))) return void (null === (n = t.parentNode) || void 0 === n || n.removeChild(t))
		},
		bs = (e, t, n) => {
		...
		Pa = () => {
			...
			return {
				...
				load: (e, o) => {
					...
					0 !== s.indexOf('/') && -1 === s.indexOf('://') && (s = Pa.baseURL + '/' + s),
	...
	const Bi = (e, t) => {
		...
		Fi = (e) =>
			e ? Te(e.childNodes, (e, t) => (Li(t) && 'BR' !== t.nodeName ? (e = e.concat(Fi(t))) : e.push(t), e), []) : [],
		Ui = (e) => (t) => e === t,
		zi = (e) =>
	...
	const Vc = rr,
		...
		Zc = (e, t, n) => {
			...
			if (t.isEqual(Ti.after(n)) && n.lastChild) {
				if (((a = Ti.after(n.lastChild)), _c(e) && Gc(n.lastChild) && Wc(n.lastChild)))
			...
			if (o && ((Sc(e) && a.isAtEnd()) || (_c(e) && a.isAtStart())) && ((o = Rc(o, e, M, n, !0)), Xc(o, n)))
				return Jc(e, o)
			r = o ? Rc(o, e, Xc, n) : o
			const d = De(
				G(
		...
		su = (e, t, n) =>
			ru(e, t, n).bind((o) =>
				...
				((e, t, n) => {
					return e
						? !ou(t, n) && ((o = t), !(!Ti.isTextPosition(o) && tr(o.getNode()))) && nu(t) && tu(n)
						: !ou(n, t) && tu(t) && nu(n)
					var o
				})(e, n, o)
					? ru(e, t, o)
		...
		yu = (e, t) =>
			uu(e).fold(L, (e) => (t.setStart(e.container(), e.offset()), t.setEnd(e.container(), e.offset()), !0)),
		Cu = (e, t, n) =>
			!(
				!((e) => !e.hasChildNodes())(t) ||
				!gu(e, t) ||
	...
	const ef = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
		...
		xf = (e) => {
			...
			if (t === o && Yo(t)) {
				...
				(Yo(t) && n > 0 && n < t.data.length && ((t = wf(t, n)), (n = 0)), Yo(o) && r > 0 && r < o.data.length)
			) {
				const e = wf(o, r).previousSibling
				;(o = e), (r = e.data.length)
			}
	...
	const rg = _a.DOM,
		...
		dg = (e, t) => {
			e.focusedEditor === t.editor && (e.focusedEditor = null),
				!e.activeEditor && og && (rg.unbind(document, 'focusin', og), (og = null))
		},
		cg = (e, t) => {
			;((e, t) =>
		...
		isEmpty(e, t = {}, n) {
			...
			if (s)
				do {
					...
					if (3 === s.type && s.parent && t[s.parent.name] && rs(null !== (o = s.value) && void 0 !== o ? o : ''))
						return !1
					if (n && n(s)) return !1
				} while ((s = Sg(s, r)))
			return !0
	...
	const zg = ['font', 'text-decoration', 'text-emphasis'],
					...
					((e) => {
						const t = e.data,
							n = ((e) => {
								const t = e.split('')
								return V(t, (e, n) =>
									Nu(e) && n > 0 && n < t.length - 1 && Au(t[n - 1]) && Au(t[n + 1]) ? ' ' : e
								).join('')
							})(t)
			...
			const i = ((e, t, n) => {
				...
				return (
					...
					s.isSome() && a.isSome() && i.isSome()
						...
						: I.none()).orThunk(() => (n && (o.each((e) => Mp(e.dom, e.dom.length)), r.each((e) => Lp(e.dom, 0))), t))
				)
				var s, a, i, l
		...
		rh = (e, t, n, o = !0) => {
			...
			if (
				(a.dom === e.getBody() ? nh(e, o) : us(a) && (Ar(a), o && e.selection.setCursorLocation(a.dom, 0)), !xn(n, a))
			) {
				const e = Pt(Nn(a), n)
					? []
					: Nn((i = a))
				...
				const o = e.selection.getRng(),
					r = n
						.bind(({ rng: n, isStartInTable: r }) => {
							const s = ((e, t) => I.from(e.dom.getParent(t, e.dom.isBlock)).map(bn))(
								e,
							...
							us(o)
								...
								: ((e, t, n, o, r) =>
										su(n, e.getBody(), r).bind((e) =>
											Eh(t, bn(e.getNode())).bind((e) => (xn(e, o) ? I.none() : I.some(E)))
										))(e, n, t, o, r)
						)
					})(e, t, o, n).orThunk(() =>
						Mt(
									...
									su(n, e.getBody(), r).fold(
										...
										(s) =>
											((e, t, n, o) =>
												cu(e.dom)
													.bind((r) =>
														uu(e.dom).map((e) => (t ? n.isEqual(r) && o.isEqual(e) : n.isEqual(e) && o.isEqual(r)))
													)
													.getOr(!0))(o, n, r, s)
												? ((e, t) => _h(e, t))(e, o)
												: ((e, t, n) =>
		...
		tb = (e, t) =>
			((e, t) => {
				const n = e.dom
				return n.parentNode
					? ((e, t) => J(e.dom.childNodes, (e) => t(bn(e))).map(bn))(bn(n.parentNode), (n) => !xn(e, n) && t(n))
					: I.none()
			})(e, t).isSome(),
		nb = (e) => (w(e) ? e : L),
		ob = (e, t, n) => {
		...
		ib = (e, t, n) =>
			!(!fm(n) || !rb(t, n.inline)) || !(!um(n) || !rb(t, n.block)) || (!!mm(n) && zo(t) && e.is(t, n.selector)),
		lb = (e, t, n, o, r, s) => {
			const a = n[o],
				i = 'attributes' === o
	...
	const _b = ['fontWeight', 'fontStyle', 'color', 'fontSize', 'fontFamily'],
		Nb = (e, t) => {
			const n = e.get(t)
			return p(n)
				? J(n, (e) => fm(e) && 'span' === e.inline && ((e) => f(e.styles) && $(me(e.styles), (e) => H(_b, e)))(e))
				: I.none()
		},
		...
		tv = (e, t, n, o) =>
			Zb(e, t, n, o, o).fold(N(o), (t) => (e.dom.createFragment().appendChild(o), e.dom.rename(o, t)), N(null)),
		nv = (e, t, n, o, r) => {
			const s = e.formatter.get(t),
				...
				m = (e) => {
					...
					if (t) {
						...
						return (
							((e) => _u(e) && zo(e) && ('_start' === e.id || '_end' === e.id))(n) &&
			...
			return (
				...
				(!!/((java|vb)script|mhtml):/i.test(o) ||
					(!e.allow_html_data_urls &&
						(/^data:image\//i.test(o)
							? ((e, t) => (C(e) ? !e : !C(t) || !H(_y, t)))(e.allow_svg_data_urls, n) &&
	...
	const By = (e, t, n, o) => {
		...
		Dy = (e, t, n, o, r) =>
			!(o in Ay && Ny(e, r, n)) && (!e.validate || t.isValid(n, o) || He(o, 'data-') || He(o, 'aria-')),
		...
		yC = (e) => ({
				...
				closest: (t) =>
					((e, t) => {
						...
						return I.from(e.selection.getStart(!0))
							.bind((o) =>
								ob(bn(o), (n) => ue(t, (t) => ((t, n) => (db(e, t.dom, n) ? I.some(n) : I.none()))(n, t)), n)
							)
							.getOrNull()
					})(e, t),
			...
			editor: {
				getContent: (t) =>
					((e, t) => I.from(e.getBody()).fold(N('tree' === t.format ? new Rg('body', 11) : ''), (n) => Lg(e, t, n)))(
						e,
						t
					),
				setContent: (t, n) =>
		...
		RC = (e, t, n, o) => {
			...
			const { selectorChangedWithUnbind: a } = ((e, t) => {
				...
				f = {
					...
					getContent: (e) =>
						((e, t = {}) => ((e, t, n) => xC(e).selection.getContent(t, n))(e, t.format ? t.format : 'html', t))(o, e),
					setContent: i,
			...
			return (
					...
					})(n, e),
				{
					...
					formatChanged: (t, o, r, s) =>
						((e, t, n, o, r, s) => xC(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
					getCssText: O(_w, e)
				}
			)
		},
			...
			e
				? ((e) => {
						...
						if (cx(e.previousSibling))
							return mx(e.previousSibling) || e.previousSibling.appendData(Tr), e.previousSibling
		...
		Ax = (e) => {
			return (
				...
				!(
					...
					((e) => Wp.test(e))(null !== (n = t.textContent) && void 0 !== n ? n : '')
				)
			)
			var t, n
		},
	...
	const ak = (e, t, n, o, r, s) => {
		...
		kk = (e, t, n) =>
			...
			((e, t) => {
				...
				return (
					...
					(e && zr(o) ? Fx(!0, t.selection, o) : !(e || !jr(o)) && Fx(!1, t.selection, o))
				)
			})(e, t),
		Ek = (e) => {
			const t = Aa(null),
		...
		Vk = (e, t) =>
			(e || 'table' === jt(t) ? 'margin' : 'padding') + ('rtl' === ao(t, 'direction') ? '-right' : '-left'),
		qk = (e) => {
			const t = Kk(e)
			return (
				!e.mode.isReadOnly() &&
		...
		Qk = (e, t, n) =>
			ue([Xk, lx, ex, (e, n) => Ok(e, t, n), Vw, Ah, dx, Hk, Kw, Fk], (t) => t(e, n)).filter((t) =>
		...
		rE = (e) => {
			...
			if (!o.isValidChild(u, c.toLowerCase()) || ((e, t, n) => $(rp(bn(n), bn(t)), (t) => eE(e, t.dom)))(r, a, s))
				return
			const m = n.getRng(),
		...
		lE = (e, t) => {
			t.hasAttribute('data-mce-caret') &&
				(Vr(t), e.selection.setRng(e.selection.getRng()), e.selection.scrollIntoView(t))
		},
		dE = (e, t) => {
			const n = ((e) =>
		...
		bE = (e, t) => {
			...
			return ((e, t) => {
				...
				if (
					((e, t, n) =>
						t ? ((e, t) => Gx(e, t).breakAt.isNone())(e.dom, n) : ((e, t) => Kx(e, t).breakAt.isNone())(e.dom, n))(
						n,
						t,
						o
					)
		...
		wE =
			...
			() =>
				e.apply(null, t),
		xE = (e, t) =>
			J(((e, t) => te(((e) => V(e, (e) => ({ ...yE, ...e })))(e), (e) => (CE(e, t) ? [e] : [])))(e, t), (e) =>
				e.action()
			),
		kE = (e, t) =>
			ue(((e, t) => te(((e) => V(e, (e) => ({ ...yE, ...e })))(e), (e) => (CE(e, t) ? [e] : [])))(e, t), (e) =>
				e.action()
			),
		EE = (e, t) => {
			const n = t ? $c.Forwards : $c.Backwards,
		...
		GE = (e, t) => {
			...
			return ((e, t) =>
				((e, t, n = L) =>
					n(t) ? I.none() : H(e, jt(t)) ? I.some(t) : Qn(t, e.join(','), (e) => Cn(e, 'table') || n(e)))(
					['td', 'th'],
					e,
					t
				...
				xe(o, e).fold(
					...
					(e) =>
						((e, t, n, o) =>
							xe(n, o).fold(
								() =>
									((e, t, n) => pS(e, () => 'The chosen schema: "' + n + '" did not exist in branches: ' + gS(t)))(
										e,
										n,
										o
									),
			...
			switch (e.tag) {
				case 'required':
					return ((e, t, n, o) =>
						xe(t, n).fold(
							() =>
								((e, t, n) => pS(e, () => 'Could not find valid *required* value for "' + t + '" in ' + gS(n)))(
									e,
									n,
									t
								),
		...
		qS = (e, t, n) =>
			$S(
				...
				((e) => {
					return (
						(t = (t) =>
							H(e, t) ? tl.value(t) : tl.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`)),
						xS((e) => t(e).fold(mS, uS))
					)
					var t
				})(n)
	...
	const h_ = (e) => {
		...
		P_ = {
			insert: (e, t) => {
				...
				if (
					('LI' !== x || b || ((w = s), (s = s.parentNode), (r = x)), /^(LI|DT|DD)$/.test(r) && zo(s) && i.isEmpty(w))
				)
					return void ((e, t, n, o, r) => {
						...
						if (N_(n, o, !0) && N_(n, o, !1))
							...
							E_(n, 'LI')
								? (s.insertAfter(d, __(n)), d.appendChild(s.doc.createTextNode(' ')), d.appendChild(n))
								: i.insertBefore(d, n),
								s.remove(o)
								...
								t.isDefaultPrevented() ||
									((e, t, n) => {
										...
										r.isMacOS() && n && a.push({ keyCode: s.isFirefox() ? 224 : 91, action: wE(zk, e) }),
											xE(
												[{ keyCode: Vm.BACKSPACE, action: wE(ix, e) }, { keyCode: Vm.DELETE, action: wE(ix, e) }, ...a],
												t
											)
									})(e, t, n),
									(n = !1)
							...
							t.isDefaultPrevented() ||
								((e, t) => {
									kE([{ keyCode: Vm.SPACEBAR, action: wE(uN, e) }], t).each((n) => {
										t.preventDefault(),
											C_(e, 'insertText', { data: ' ' }).isDefaultPrevented() ||
	...
	const rR = (e, t) => Math.abs(e.left - t),
		...
		BR = (e) => {
			...
			const l = (e) => e !== o && (OR(e) || ir(e)) && n.isChildOf(e, o) && n.isEditable(e.parentNode),
				...
				f = (r, c) => {
					...
					const g = r.endOffset
					if (
						(Yo(m) && 0 === f && OR(m.parentNode) && ((m = m.parentNode), (f = n.nodeIndex(m)), (m = m.parentNode)),
						!zo(m))
					)
						return null
		...
		XR = (e, t, n, o) => {
			...
			return ZE(i, l - n.pattern.end.length, t).bind((d) => {
				...
				if (GR(a)) return I.some({ matches: [{ pattern: a, startRng: c, endRng: c }], position: d })
				{
					...
					return m.map((e) => {
						const t = ((e, t, n, o = !1) => LR(e, t, n.startContainer, n.startOffset, n.endContainer, n.endOffset, o))(
							r,
							s,
							e,
							o
							...
							return ((e, t) => {
								...
								.map((e) =>
									Dt.trim(i).length === e.start.length
										? []
										: [{ pattern: e, range: LR(s, s.getRoot(), t, 0, t, 0, true) }]
								)
								.getOr([])
						})(e, o, a)
					return (
		...
		mA = (e) => {
			...
			;(o.disabled = !0),
				(e.readonly = vd(e)),
				e.readonly ||
					(e.inline && 'static' === rA.getStyle(o, 'position', !0) && (o.style.position = 'relative'),
					...
					((e) => {
						;((e) => {
							const t = [',', '.', ';', ':', '!', '?'],
								...
								o = () => {
									return (
										(t = Vd(e)), (n = qd(e)), { inlinePatterns: il(t), blockPatterns: al(t), dynamicPatternsLookup: n }
									)
									var t, n
								},
				...
				((e) => {
					...
					if (m(t)) {
						...
						;(e.theme = n(e, nw.urls[t]) || {}),
							w(e.theme.init) && e.theme.init(e, nw.urls[t] || e.documentBaseUrl.replace(/\/$/, ''))
					} else e.theme = {}
				})(e),
				((e) => {
					const t = od(e),
				...
				e.inline
					...
					: ((e, t) => {
							;((e, t) => {
								...
								t.editorContainer &&
									((t.editorContainer.style.display = e.orgDisplay), (e.hidden = gA.isHidden(t.editorContainer))),
			...
			;(this.options = ((e, t) => {
				const n = {},
					...
					r = (e, t, n) => {
						...
						return fO(r)
							? ((o[e] = r.value), !0)
							: (console.warn(mO(`Invalid value passed for the ${e} option`, r)), !1)
					},
					s = (e) => ke(n, e)
				return {
					register: (e, s) => {
		...
		render() {
			;((e) => {
				...
				e.on('remove', () => {
					...
					(e.ui.styleSheetLoader = ((e, t) => Os.forElement(e, { contentCssCors: yd(t), referrerPolicy: zl(t) }))(
						o,
						e
					)),
					ud(e)
				...
				s &&
					...
					md(e) &&
						!Go(e.getElement()) &&
						(yA.insertAfter(yA.create('input', { type: 'hidden', name: t }), t), (e.hasHiddenInput = !0)),
	...
	const DO = (e) => {
		...
		IO = {
			...
			_setBaseUrl(e) {
				;(this.baseURL = new Ry(this.documentBaseURL).toAbsolute(e.replace(/\/+$/, ''))),
		...
		VO = {
			...
			clamp: (e, t, n) => {
				...
				const i = t.x + t.w,
					...
					m = zO(0, a - l)
				return (
					(o += d), (r += c), n && ((s += d), (a += c), (o -= u), (r -= m)), (s -= u), (a -= m), $O(o, r, s - o, a - r)
				)
			},
			create: $O,
